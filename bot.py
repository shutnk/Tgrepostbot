...
# === ЭМОДЗИ ДЛЯ КАЖДОЙ ТЕМЫ (будут в названии и на иконке) ===
EMOJI_MAP = {
    "Часы": "🕐",
    "Сумки Hermes": "👜",
    "Обувь Hermes": "👟",
...
def create_topic(original_name):
    # Берём эмодзи или ставим 🔹 по умолчанию
    emoji = EMOJI_MAP.get(original_name, "🔹")
    # Полное название с эмодзи в начале: "🕐 Часы"
...
def main():
    logger.info("🚀 Начинаю создание тем с эмодзи в названии (гарантированно работает)...")
    ...
    for idx, name in enumerate(TOPICS, 1):
        ...
        # Ждём 5 секунд, чтобы Telegram не выдавал Too Many Requests
        time.sleep(5)
